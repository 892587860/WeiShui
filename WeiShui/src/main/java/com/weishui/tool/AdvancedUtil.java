...
public class AdvancedUtil {
	 ...
	 * ��ȷʱ���ص�JSON���ݰ����£� { "access_token":"ACCESS_TOKEN",
...
//			wat = JSONObject.parseObject("{\"errcode exception\":\"" + a + "\"}");
			wat = JSONObject.parseObject("{\"errcode exception\":\"" + e.getStackTrace() + "\"}");
			return wat;
		}
...
//			String a = org.apache.commons.lang.exception.ExceptionUtils.getFullStackTrace(e);
			wat = JSONObject.parseObject("{\"json exception\":\"" + e.getStackTrace() + "\"}");
